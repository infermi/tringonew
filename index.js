...
PostBE.onclick = function() {
    ...
    if (game == "" || session == "" || code == "") {
        ...
        scrape(`https://606b158af8678400172e58d5.mockapi.io/api/Expose?gameID=${game}&sessionID=${session}?CODE=${code}`, "POST");
    };
}

// `https://606b158af8678400172e58d5.mockapi.io/api/Expose`
// `<img id="Qimg" src="${jsonResponse._children.question._value.question.replace(/ /g, '').slice(5)}" onerror="this.src='http://weil-law.com/wp-content/plugins/gallery-images/assets/images/admin_images/No-image-found.jpg';this.onerror=null">`
        ...
        if (xhr.status === 200 || xhr.status === 201) {
            ...
            if (jsonResponse._children.result._value === "ok") {
                ...
                if (jsonResponse._children.question._value.question.replace(/ /g, '').slice(0, 5) === "link:") {
                    displayE.innerHTML = `<img id="Qimg" src="${jsonResponse._children.question._value.question.replace(/ /g, '').slice(5)}" onerror="this.src='http://weil-law.com/wp-content/plugins/gallery-images/assets/images/admin_images/No-image-found.jpg';this.onerror=null">`
                } else {
                ...
                console.log(jsonResponse._children.result._value)
            }
